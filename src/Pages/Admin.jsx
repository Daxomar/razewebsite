...
const Admin = () => {
  return (
    <div className="px-[8px]">
      <div className="border-2 borer-black w-full flex items-center justify-center mt-16 rounded-[20px] px-4 pt-4 bg-[#EAEAEA]">
        ...
        <div className=" w-full ">
          <div className=""><img src="/Background.png" /></div>
        </div>
      </div>
